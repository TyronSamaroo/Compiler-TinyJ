...
//    }
  ...
  private static void outputStmt() throws SourceFileErrorException
  {
    ...
    switch (getCurrentToken()) {
      ...
      accept(LPAREN);printArgument();accept(RPAREN);accept(SEMICOLON);
      break;
      case PRINTLN: nextToken();
      accept(LPAREN);if(getCurrentToken() != RPAREN) printArgument();accept(RPAREN);accept(SEMICOLON);
      break;
  ...
  private static void expr1() throws SourceFileErrorException
  {
    ...
    switch (getCurrentToken()) {
      case LPAREN:nextToken();expr7();accept(RPAREN);
      break;
      case PLUS:
      case MINUS:
      case NOT:
      ...
      case NULL:
        ...
        break;
      case NEW: nextToken();
        accept(INT); accept(LBRACKET); expr3(); accept(RBRACKET);
        while(getCurrentToken() == LBRACKET){
          nextToken();
          accept(RBRACKET);
        }
